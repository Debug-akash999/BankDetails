...
public class BankDetailsController {
    ...
    public BankDetails deposit(@PathVariable Long id, @RequestBody AmountDTO dto) {
        return service.deposit(id, dto.getAmount());
    }

    @PostMapping("/{id}/withdraw")
    public BankDetails withdraw(@PathVariable Long id, @RequestBody AmountDTO dto) {
        return service.withdraw(id, dto.getAmount());
    }

    @PostMapping("/transfer")
    public Transaction transfer(@RequestBody TransferDTO dto) {
        return service.transfer(dto.getFromId(), dto.getToId(), dto.getAmount());
    }
